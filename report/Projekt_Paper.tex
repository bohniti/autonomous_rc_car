...
We decided to commit ourselves to this kind of project, because we are interested in many aspects related to machine learning. We knew that our skills and knowledge were at the starting point not deep enough, but after successfully completing this project within two semesters we gained a lot of information and understand everything perfectly now. Along the many hours we spent, we had to learn new things and we can say with some proud that we managed to make the car drive autonomously - with a lot of effort though.
It is known, that the car industry(especially in Germany) undergoes currently a shift towards electric and autonomous-driving cars. The old engine-driven cars seem to be \textit{old technology}. For three eager students who are interested in informatics and everything which is related to computers, a new opportunity arose and is still arising. Especially in the area of autonomous-driving cars, companies invest a lot of money and time. They also search for talents which could make the difference in the future. It was especially hard in the beginning to split the responsibilites and figure out who takes care of which element in the project. Even the first car we bought was not compatible to the hardware we bought(Raspberry Pi 3B+, Servodriver, e.g.). That did not stop us from learning about the hardware and the software we wanted to use more precisely. How we combine the hardware with the right software, so that the car can move on its own, was one of the most exciting and interesting aspects we wanted to explore.
